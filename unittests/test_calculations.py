...
# Creating a TestSuite that will run only the specified tests

def make_suite():
    # Create a list of all tests from the TestArithmeticOperations test case
    arithmetic_tests = [
...
def make_statistical_suite():
    ...
    # or you could do:
    stats_suite = unittest.TestSuite(tests=statistical_tests)
